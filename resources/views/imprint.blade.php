        ...
        <div class="col-lg-9">
            <div class="card shadow-lg border-0 rounded-4">
                ...
                <div class="card-body px-4 py-5">
                    ...
                    <div class="mb-4">
                        <h5 class="fw-semibold text-primary"><i class="fas fa-building me-2"></i>Company Name</h5>
                        <p class="mb-0">Example Company Ltd.</p>
                    </div>

                    <div class="mb-4">
                        <h5 class="fw-semibold text-primary"><i class="fas fa-map-marker-alt me-2"></i>Address</h5>
                        <p class="mb-0">123 Example Street, City, Country, 12345</p>
                    </div>

                    <div class="mb-4">
                        <h5 class="fw-semibold text-primary"><i class="fas fa-envelope me-2"></i>Contact Information</h5>
                    ...
                    <div class="mb-4">
                        <h5 class="fw-semibold text-primary"><i class="fas fa-briefcase me-2"></i>Legal Information</h5>
                    ...
                    <div class="mb-4">
                        <h5 class="fw-semibold text-primary"><i class="fas fa-exclamation-circle me-2"></i>Disclaimer</h5>
                    ...
                    <div class="mb-4">
                        <h5 class="fw-semibold text-primary"><i class="fas fa-copyright me-2"></i>Copyright</h5>
                        <p class="mb-0">© 2023 Example Company Ltd. All rights reserved.</p>
                    </div>

                    <div class="mb-4">
                        <h5 class="fw-semibold text-primary"><i class="fas fa-link me-2"></i>Links to Other Websites</h5>
                    ...
                    <div class="mb-4">
                        <h5 class="fw-semibold text-primary"><i class="fas fa-sync-alt me-2"></i>Changes to This Imprint</h5>
