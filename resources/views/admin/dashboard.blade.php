                        ...
                        <div class="card-body p-1">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 text-end">
                                    <h3 class="mb-1 text-dark fw-bold"><span class="counter" data-target="{{$stores->count()}}">0</span></h3>
                    ...
                    <div class="card widget-card hover-scale" style="border-left: 4px solid #28c76f;">
                        <div class="card-body p-1">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 text-end">
                                    <h3 class="mb-1 text-dark fw-bold"><span class="counter" data-target="{{$coupons->count()}}">0</span></h3>
                    ...
                    <div class="card widget-card hover-scale" style="border-left: 4px solid #00cfe8;">
                        <div class="card-body p-1">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 text-end">
                                    <h3 class="mb-1 text-dark fw-bold"><span class="counter" data-target="{{$categories->count()}}">0</span></h3>
                    ...
                    <div class="card widget-card hover-scale" style="border-left: 4px solid #ff9f43;">
                        <div class="card-body p-1">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 text-end">
                                    <h3 class="mb-1 text-dark fw-bold"><span class="counter" data-target="{{$networks->count()}}">0</span></h3>
                    ...
                    <div class="card widget-card hover-scale" style="border-left: 4px solid #000000;">
                        <div class="card-body p-1">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 text-end">
                                    <h3 class="mb-1 text-dark fw-bold"><span class="counter" data-target="{{$languge->count()}}">0</span></h3>
